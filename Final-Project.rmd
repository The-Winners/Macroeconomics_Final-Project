...
We consider a fairly general state-space model specification: the notation  Harvey's model (1989). Let
αt = ct+Ttαt−1+Rtηt (1) 
yt = dt+Ztαt+εt (2)
where ηt ∼ N(0,Qt) and εt ∼ N(0,Ht). The state equation (1) describes the dynamics of the state vector αt, 
driven by deterministic (ct) and stochastic (ηt) inputs. The observation (or measurement) equation links 
the observed response yt with the unobserved state vector, with noise εt and (possibly) deterministic inputs dt.
