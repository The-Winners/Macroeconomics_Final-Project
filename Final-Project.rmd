...
## Empirical Results
We estimate the parameter $d$ that is the fractional difference which indicates
if the CB policy is more flexibile respect to inflation target ($d>0.5$), or if
it has sticked to the inflation target despite the bussines cycle or other economic determinats.
...
```
In the EU, the estimation of fractional integration order $d$ is quite high $>0.9$, thus 
...
In other words, inflation exhibits long swings around its mean.

### Germany

```{r c15, message=FALSE, warning=FALSE, echo=FALSE}
print("Table 2.1: Germany 1993-2006")
kable(kalmanfilter(gerpart1$Rate))
print("Table 2.2: Germany 1999-2017")
